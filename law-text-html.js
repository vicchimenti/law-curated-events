...
try {
    ...
    // Open the Curated Events Box
  	document.write('<div class="featuredCuratedEventsWrapper contentItem curatedEventsBox' + content.get('Background Color').publish() + ' g-0" id="id' + content.getID() + '" style="background-image:linear-gradient(' + bgRGBA + ',' + bgRGBA + '),url(' + bgImage + ');" data-position-default="Main" data-position-selected="Main"><div class="curatedEventsTitle"><h2 id="labelForFeaturedEvents"><span>' + content.get('Box Title') + '</span></h2></div><div class="featuredCuratedEvents standardContent"><ul class="curatedEventsList">');
